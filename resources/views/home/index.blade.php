            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-6 fw-bolder text-white mb-2">iPagar: Layanan Pembuatan Pagar, Pengaman Jendela, Dan Pengelasan
                        </h1>
                        <p class="lead fw-normal text-white-50 mb-4">Nikmati banyak layanan yang dapat memanjakan anda untuk pembuatan pagar, pengaman jendela, dan pengelasan</p>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                            <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">Pesan Sekarang</a>
                            <a class="btn btn-outline-light btn-lg px-4" href="#!">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center">
                    <img class="img-fluid rounded-3 my-5" src="assets/undraw_online_stats_0g94.svg"
                        alt="..." />
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="row gx-5 row-cols-1 row-cols-md-2">
                        <div class="col mb-5 h-100">
                            ...
                            <p class="mb-0">Anda dapat memilih jenis layanan, tanggal, dan jam yang diinginkan melalui aplikasi secara online.</p>
                        </div>
                        <div class="col mb-5 h-100">
                            <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i
                                    class="bi bi-building"></i></div>
                            <h2 class="h5">Pembaruan Proyek Langsung</h2>
                            <p class="mb-0">Memberikan akses kepada anda untuk melacak progress proyek secara langsung melalui aplikasi.</p>
                        </div>
                        <div class="col mb-5 mb-md-0 h-100">
                            <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i
                                    class="bi bi-toggles2"></i></div>
                            <h2 class="h5">Konsultasi Virtual</h2>
                            <p class="mb-0">Menyediakan fitur konsultasi virtual melalui chat langsung sehingga anda dapat berinteraksi langsung dengan ahli secara lebih personal.</p>
                        </div>
                        <div class="col h-100">
                            <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i
                                    class="bi bi-toggles2"></i></div>
